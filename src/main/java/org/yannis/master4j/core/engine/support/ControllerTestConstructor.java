...
public class ControllerTestConstructor {
    ...
    public static void construct(final Context context) {
        ...
        FileUtils.mkdir(controllerTestPath);
        ...
        for (final BeanInfo beanInfo : beanInfoList) {
            ...
            final String className = beanInfo.getControllerName()+"Test";
            ...
            Map<String, Object> root = new HashMap<String, Object>() {
                {
                    ...
                    put("fields", fields);
                    put("controllerName", beanInfo.getControllerName());
                    put("dtoName", beanInfo.getDtoName());
                }
            };

            TemplateUtils.process(templateRoot + "/class/ControllerTest.ftl", root,
                controllerTestPath + "/" + className + ".java");
        }
    }
}
