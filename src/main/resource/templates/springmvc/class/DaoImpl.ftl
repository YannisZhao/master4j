...
public class ${className} implements ${baseClassName} {
    ...
    @Override
    public ${dtoName} findById(String id) throws DaoException {
    ...
    @Override
    public List<${domainName}> findByPage(SqlParamWrapper[] params, Paginator paginator) throws DaoException {
    ...
    @Override
    public long getTotalRows(SqlParamWrapper[] params) throws DaoException {
        return jdbcTemplate.queryForObject("SELECT COUNT(1) FROM application", new Object[]{}, Long.class);
    }

    @Override
    public boolean save(${domainName} obj) throws DaoException {
        if(obj == null){
    ...
    @Override
    public int batchSave(List<${domainName}> objs) throws DaoException {
        return 0;
    }
    ...
    @Override
    public int batchRemove(String[] ids) throws DaoException {
        return 0;
    }

    @Override
    public boolean update(${domainName} obj) throws DaoException {
        return false;
    }

    @Override
    public int batchUpdate(List<${domainName}> objs) throws DaoException {
